		...
		<div class="container">
		  <div class="row">
			<div class="col-md-2 col-xs-4">
			  <figure>
				<img src="<?php print_custom_field('album_cover:to_image_src'); ?>" width="200" class="img-responsive" /><br/>
			  </figure>
			</div>
			<div class="col-md-8">
		...
		<ol>
			<?php 
				...
				if ( $episodes->have_posts() )
				{
					...
					{
						$url1 = get_permalink() ;
						$audio_url = get_custom_field('AudioURL');
						echo '<li>'."<a href=$url1>".get_custom_field('episode')."</a><span class='glyphicon glyphicon-play clk' audio=$audio_url></span></li>";
